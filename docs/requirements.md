...
|  10 | Add order history to the ID token at login                           | Auth0 Post-Login Action                      | Claim shown in Behind the counter; Action tests, shared golden fixtures and fresh hosted token after reset | Complete |
