...
|  10 | Add order history to the ID token at login                           | Auth0 Post-Login Action                      | Deployed Action parity and Action tests; recapture a fresh token after reset | Deployed; evidence to recapture |
